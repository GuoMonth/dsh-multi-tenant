...
>
> 只需 Node/npm 与可用 Docker；默认免 API key。参见[快速体验与源码验证](https://github.com/GuoMonth/dsh-multi-tenant/blob/main/docs/reference/quickstart.zh-CN.md)。以下保留平台 SDK 的完整接入说明。
