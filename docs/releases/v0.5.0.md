...
Local Node matrix and full release-check results are recorded in the [alignment review](../archive/dsh-0.1.5-alpha.1-review.zh-CN.md). GitHub CI and registry publication are independently verifiable actions.
